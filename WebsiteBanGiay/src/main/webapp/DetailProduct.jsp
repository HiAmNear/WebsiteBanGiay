  ...
  <main>
    <div class="container">
          ...
          <div class="col-md-6">
            ...
            <div class="table-responsive">
              <table class="table table-sm table-borderless mb-0">
                <tbody>
                  <tr>
                    <th class="pl-0 w-25" scope="row"><strong>Mẫu Giày</strong></th>
                    <td>${detail.model }</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <th class="pl-0 w-25" scope="row"><strong>Khu Vực Giao Hàng</strong></th>
            ...
            <div class="table-responsive mb-2">
              <table class="table table-sm table-borderless">
                <tbody>
                  <tr>
                    <td class="pl-0 pb-0 w-25">Số Lượng Đặt</td>
                    <td class="pb-0">Cỡ Giày</td>
                  </tr>
                  <tr>
                    <td class="pl-0">
                    <div class="mt-1">
      ...
      <div class="classic-tabs">
        ...
        <div class="tab-content" id="advancedTabContent">
          ...
          <div class="tab-pane fade" id="reviews" role="tabpanel" aria-labelledby="reviews-tab">
            <h5><span>${countAllReview }</span> review cho sản phẩm <span>${detail.name }</span></h5>
            
             <h5 class="mt-4">Thêm review</h5>
            <p></p>
            ...
            <div>
              ...
              <div class="md-form md-outline">
                ...
                <label for="form76">review của bạn</label>
              </div>
              <div class="text-right pb-2">
                <button type="button" class="btn btn-primary" onclick="addReview(${detail.id})">Thêm review</button>
              </div>
            </div>
      ...
      <section class="text-center">
        ...
        <h4 class="text-center my-5"><strong>Các Sản Phẩm Liên Quan</strong></h4>
